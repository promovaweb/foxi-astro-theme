...
Execute o git log para ver o que mudou desde o último tag ou commit relevante:
...
Crie o arquivo `src/content/changelog/vX.Y.Z.md` com o frontmatter correto e conteúdo em **Português do Brasil**:
...
- O `title` deve conter a versão e um subtítulo descritivo (ex: `"v2.1.0: Suporte a Podcast"`)
- A `description` deve ser uma frase completa e informativa para SEO (entre 100 e 200 caracteres)
- Nunca hardcode a data — sempre use o comando para obter a data atual
- Após criar o arquivo, informe o caminho completo e mostre um preview do frontmatter gerado
