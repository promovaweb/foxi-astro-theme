...
16. **Consistência de Design (DESIGN.md)** — O `DESIGN.md` é a fonte única de verdade para UI/UX. Antes de criar qualquer componente ou página, você **DEVE** ativar a skill `ui-component` e consultar o `DESIGN.md`.
